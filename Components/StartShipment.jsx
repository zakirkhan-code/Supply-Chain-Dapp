...
export default ({startModal,setStartModal,StartShipment})=>{
  ...
  const startShipmentThe=()=>{
    startShipmentThe(getProduct);
  }
  ...
  return startModal?(
    ...
    <div className="fixed inset-0 z-10 overflow-y-auto">
      ...
      <div className="flex items-center min-h-screen px-4 py-8">
        <div className="relative w-full max-w-lg p-4 ma-auto bg-white rounded-md shadow-lg">
          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            ...
            <form action="" onSubmit={(e)=>e.preventDefault()}>
              ...
              <div className="relative mt-3">
                <input type="text" placeholder="ID" className="
                w-full pl-5 pr-3 py-2 text-gray-500 bg-transparent
                outline-none border focus:border-indigo-600 shadow-sm rounded-lg"
                onChange={(e)=>setGetProduct({
                  ...getProduct,
              ...
              <button className="block w-full mt-3 my-3 px-4 font-medium text-sm text-center
              text-white bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700
              rounded-lg ring-offset-2 ring-indigo-600 focus:ring-2" onClick={()=>startShipmentThe()} >
                Get Details
              </button>
            </form>
          </div>
